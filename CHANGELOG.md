...
- **Add: Claude Fable 5.1 model** — `claude-fable-5-1` is selectable next to `claude-fable-5`, and the `fable` shortcut selects 5.1.
- **Bump: Claude Agent SDK >=0.3.258** — required for the bundled Claude Code runtime to support Fable 5.1.
